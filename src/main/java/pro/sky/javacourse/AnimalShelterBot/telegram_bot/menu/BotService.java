...
public interface BotService {
    ...
    // List<Pet> getPetsByShelterIdAndType(Long shelterId, String petType, String petStatus); // Возвращает животных отдельного типа, например собак, из отдельного приюта, но только тех которые не на испытательном сроке, не забраны опекунами и живые
